...
int main(int argc, char *argv[])
{
    ...
    std::cout << "!             ./test_vispa absolute_path_to_test_folder          !\n";
    std::cout << "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n\n\n";
    if (argc != 2)
    {
    ...
    std::vector<double> fk_vec_values = {2.30303, 0.0323909, 1.1733, -0.320906, 1.28309, -0.577186};
    ...
    std::vector<double> ik_seed_vec_values = {2.30303, 0.0323909, 1.1733, -0.320906, 1.28309, -0.577186};
    ...
    fk_pose.position(0) = 0.307005; 
    fk_pose.position(1) = -0.448879;
    fk_pose.position(2) = 0.505166;

    fk_pose.orientation.x() = 0.966348; 
    fk_pose.orientation.y() = -0.087025;
    fk_pose.orientation.z() = -0.242031;
    fk_pose.orientation.w() = -0.004325;

    fk_pose.sourceFrame = "VISPA_BASE_LINK_link";
    fk_pose.targetFrame = "VISPA_LINK_6_link";
