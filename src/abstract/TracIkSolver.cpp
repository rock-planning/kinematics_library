...
namespace kinematics_library
{
    ...
    TracIkSolver::TracIkSolver(const KDL::Tree &kdl_tree, const KDL::Chain &kdl_chain, const KDL::Chain &kdl_kinematic_chain) : kdl_kinematic_chain_(kdl_kinematic_chain)
    {
        kdl_tree_ = kdl_tree;
