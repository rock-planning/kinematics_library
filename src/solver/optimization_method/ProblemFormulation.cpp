                                    ...
                                    const std::vector<std::pair<double, double>> &jts_limits)
{
         ...
         it != problem_param_.groove_param.end(); it++)
    {
        ...
        case POSITION_COST:
        {
            pos_groove_var_ = it->second;
            break;
        }
        case ORIENTATION_COST:
        {
            ort_groove_var_ = it->second;
            break;
        }
        case VELOCITY_COST:
        {
            vel_groove_var_ = it->second;
            break;
        }
        case ACCELERATION_COST:
        {
            acc_groove_var_ = it->second;
            break;
        }
        case JERK_COST:
        {
            jerk_groove_var_ = it->second;
            break;
        }
        case MIN_VEL_EE_COST:
        {
            min_vel_groove_var_ = it->second;
            break;
        }
        default:
        {
         ...
         it != problem_param_.costs_weight.end(); it++)
    {
        ...
        case POSITION_COST:
        {
            pos_cost_weight_ = it->second;
            break;
        }
        case ORIENTATION_COST:
        {
            ort_cost_weight_ = it->second;
            break;
        }
        case VELOCITY_COST:
        {
            vel_cost_weight_ = it->second;
            break;
        }
        case ACCELERATION_COST:
        {
            acc_cost_weight_ = it->second;
            break;
        }
        case JERK_COST:
        {
            jerk_cost_weight_ = it->second;
            break;
        }
        default:
        {
